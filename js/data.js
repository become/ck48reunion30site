...
const CK48_DATA = {
  ...
  news: [
    ...
    {
      id: 2,
      title: "報名系統即將開放，請提前準備",
      slug: "registration-coming",
      date: "2026-06-15",
      category: "公告",
      summary: "活動報名將於2026年7月1日正式開放，請各位同學提前確認個人資料與參加意願。",
      coverEmoji: "📋",
      content: `<p>各位同學，</p>
        <p>報名系統預計於2026年7月1日正式開放，本次活動分為「重聚餐會」（12月19日）及「返校日園遊會」（12月20日）兩個場次，歡迎同學依個人狀況自由選擇。</p>
        <p>本次重聚餐會地點訂於台北市某五星級飯店，詳細資訊將於報名開放前公告。</p>
        <p>敬請期待！</p>`
    },
    {
      id: 3,
    ...
    },
    {
      ...
      coverEmoji: "🎁",
      content: `<p>各位同學，</p>
        <p>為留下這次珍貴的重聚記憶，籌備委員會特別製作了多款紀念商品，包括紀念T恤、棒球帽、馬克杯及紀念手冊等。所有商品均以建中校色及CK48 Reunion為主題設計。</p>
        <p>商品數量有限，請儘早預購。詳細規格及訂購方式請前往「紀念商品」頁面。</p>`
    },
    {
      id: 5,
      title: "活動流程正式公布",
      ...
      date: "2026-09-15",
      category: "活動",
      summary: "兩日活動詳細流程正式公布，包含重聚餐會節目表及返校日行程安排。",
      coverEmoji: "📅",
      content: `<p>各位同學，</p>
        <p>兩日活動的詳細流程已正式公布，請各位同學提前查閱並安排好行程。活動詳情請參閱「活動資訊」頁面。</p>`
    },
    {
      id: 6,
      title: "大合照報名截止提醒",
      slug: "group-photo-reminder",
      date: "2026-11-01",
      category: "公告",
      summary: "返校日大合照將依班級分組拍攝，請尚未確認的同學盡快完成報名。",
      coverEmoji: "📸",
      content: `<p>各位同學，</p>
        <p>返校日大合照名單將於11月底截止確認，請尚未完成報名的同學盡快前往報名頁面完成手續。錯過截止日期將無法保留大合照位置，敬請把握機會！</p>`
    }
  ],
